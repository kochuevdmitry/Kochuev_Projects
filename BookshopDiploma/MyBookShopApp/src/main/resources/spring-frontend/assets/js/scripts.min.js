                                ...
                                $.ajax({
                                    ...
                                    complete: function (result) {
                                        if (result.status === 200) {
                                            var data = '';
                                            result.responseJSON.bookDtos.forEach(function (book) {
                            ...
                            case'search':
                                getData('/search/page/' + $this.data('refreshquery'), {
                                    offset: function () {
                                        var oldOffset = $this.data('refreshoffset');
                                        if(oldOffset < 1){
                                            //$this.data('refreshoffset', ++oldOffset); //для обычного поиска
                                            $this.data('refreshoffset', oldOffset + $this.data('refreshlimit'));//для гугл букс апи
                                        }else{
                                            //$this.data('refreshoffset', ++oldOffset - $this.data('refreshlimit'));//обычный поиск
                                            $this.data('refreshoffset', oldOffset );//для гугл букс апи
                                        }
                                        return $this.data('refreshoffset');
                                    },
                                    limit: $this.data('refreshlimit')
            ...
            return {
                init: function () {
                    ...
                    $('#submitMail').on('click', function () {
                        ...
                        postData('/requestEmailContactConfirmation', data, function (result) {
                            if (result.result) {
                    ...
                    $entryButton.on('click', function (e) {
                        ...
                        if ($this.is('[data-send]')) {
                            ...
                            if (!error  && !$(this).attr('id').match('toComeInPhone')) {
                            ...
                            Login().postData('/books/changeBookStatus/' + $this.data('bookid'), {
                                ...
                                if (result.result) {
                                    ...
                                    if ($cart.length) {
                                        ...
                                        $cart.find('.changeBookStatus-total .Cart-price').not('.Cart-price_old').text(price + ' р.');
                                    ...
                                    if ($(slick.$slider).data('load')) {
                                        ...
                                        switch ($(slick.$slider).data('load')) {
                                            ...
                                            case'popular':
                                                ...
                                                break;
                                            case'authorsBooks':
                                                sendData('/books/author/' + $this.data('authorid'))
                                                break;
                                        }
                                    }
                                }
