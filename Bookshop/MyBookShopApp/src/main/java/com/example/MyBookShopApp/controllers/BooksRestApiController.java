...
@RequestMapping("/api")
@Api("book data api")
public class BooksRestApiController extends CommonFooterAndHeaderController {

    @Autowired
    public BooksRestApiController(BookstoreUserRegisterService userRegister, BookshpCartService bookshpCartService, BookService bookService) {
